...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { code: @snippet.code, description: @snippet.description, name: @snippet.name, url: @snippet.url } }
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { code: @snippet.code, description: @snippet.description, name: @snippet.name, url: @snippet.url } }
